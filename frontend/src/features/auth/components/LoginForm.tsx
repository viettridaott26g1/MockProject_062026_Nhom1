      ...
      <Card className="w-full border-0 shadow-none">
          ...
          <form id="login-form" onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            <div className="space-y-2">
              ...
              <Input
                ...
                className={`h-11 focus-visible:ring-indigo-600 ${
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className={`h-11 pr-10 focus-visible:ring-indigo-600 ${
        ...
        <CardFooter className="flex flex-col gap-4 pb-10">
          <Button
            ...
            form="login-form"
            disabled={isPending}
            className="h-12 w-full rounded-xl bg-indigo-600 text-base font-semibold text-white transition-all duration-300 hover:bg-indigo-700 focus-visible:ring-indigo-600 active:scale-[0.98]"
          >
            {isPending ? (
              <>
          ...
          <Button
            type="button"
            variant="outline"
            className="h-12 w-full rounded-xl border-slate-200 bg-white text-base font-semibold text-slate-700 transition-all duration-300 hover:bg-slate-50 hover:text-slate-900 active:scale-[0.98]"
          >
            <svg
